...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release.mk dist/Release/GNU-Linux-x86/entropycalculations

dist/Release/GNU-Linux-x86/entropycalculations: ${OBJECTFILES}
...
${TESTDIR}/tests/InterpTests.o: tests/InterpTests.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -w -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/InterpTests.o tests/InterpTests.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/GNU-Linux-x86/entropycalculations
